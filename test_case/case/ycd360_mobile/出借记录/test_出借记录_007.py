...
class TestCJJL(unittest.TestCase):
    ...
    def test_procedure(self):
        ...
        xmqx = self.datatools.getExcelDateRowValue('出借记录', '还款方式', self.case_id)
        ...
        xmqx_get = self.functionlibrary.getCJJLXQ("项目还款方式")
        self.functionlibrary.dataCompare(xmqx, xmqx_get)
